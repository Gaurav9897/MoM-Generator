...
st.title('MoM GENERATOR:- AI ASSISTED MINUTES OF MEETING GENERATOR')
st.subheader('This Application creates a generalized minutes of meeting from the Handwritten Notes')
st.write('''
Follow these steps :-
